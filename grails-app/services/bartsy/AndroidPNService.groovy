...
class AndroidPNService {
    ...
    public void sendPN(String orderStatus,String orderId,String registrationId){
        try {
...
//            .delayWhileIdle(true)
	...
	public void sendPlaceOrderPN(String orderStatus,String orderId,String itemName,String orderTime,String basePrice,String tipPercentage,String totalPrice,String registrationId){
		try {
			log.info("Came into the android push")
			//println "Came into the android push"
			//String apiKey = "AIzaSyD8HRgmmsbrAqBOFQGngf5MkHYG1qacj9Q" // development
