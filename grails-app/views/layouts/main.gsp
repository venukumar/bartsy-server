...
<!--[if (gt IE 9)|!(IE)]><!--> <html lang="en" class="no-js"><!--<![endif]-->
  ...
  <g:if test="${session.user}">
 	...
 	<div class="main_navigation">
 		<ul>
			<li><g:link controller="admin" action="summary"><g:message code="default.home.label" default="Home" class="active"/></g:link></li> 
			<!--  <li><g:link controller="admin" action="usersList"><g:message code="user.label" default="Users" class="active" /></g:link></li>-->
			<li><g:link controller="admin" action="saleuserList"><g:message code="user.label" default="Users" class="active" /></g:link></li>
