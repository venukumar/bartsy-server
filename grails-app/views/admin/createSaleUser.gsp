...
<html>
  <head>
    ...
    <title><g:message code="page.create.sale.title" default="Create Sales Account" /></title>
</head>
<body>
  <h1><g:message code="page.create.sale.title" default="Create Sales Account" /></h1>
