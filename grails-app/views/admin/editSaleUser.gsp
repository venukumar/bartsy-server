...
<body>
  <h1 style="border-bottom:1px solid #e7e7e7;"><g:message code="page.edit.title" default="Edit Account" /></h1>
  ...
  <input type="hidden" name="id" value="${params.id}">
   ...
   <div id="timer" class="label-row">
    ...
    <div class="button-con" style="padding:10px 0px 0px 148px;"> 
      <g:submitButton name="create" value="${message(code: 'default.button.update.label', default: 'Update')}" />
      <%--<input type="button" name="cancel" value="${message(code: 'cancelbutton.label', default: 'Cancel')}" onclick="window.location.href='${request.getContextPath()}/admin/saleuserList'" />--%>
